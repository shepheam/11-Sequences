...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [45, 84, 32, 70, -10, 40, 2, 3, 4, 5, 67]
    threshold = 4
    expected = 7
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([1, 2, 23])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 0
    actual = sum_first_n([48, -10, 50, 5, 2, 43, 33], 0)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 50
    actual = sum_first_n([5, 2, 43, 33], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
